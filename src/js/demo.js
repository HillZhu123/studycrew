...
function detectTemplate(topic) {
  ...
  // 目前 demo 重点做 IGCSE Physics Paper 4 力学
...
async function runDemo() {
  ...
  const critic = `第 2 题诊断（力矩）：\n${criticAnalysis(tpl).q2}\n\n第 4 题诊断（净功/能量）：\n${criticAnalysis(tpl).q4}\n\n通用修正：\n${criticAnalysis(tpl).general}`;
